...
if not jsonl_files:
    print("Tidak ada file .jsonl ditemukan di data/raw/orders/")
    spark.stop()
    exit()
...
print(f"Total records setelah dibersihkan: {df_clean.count()}")

df_clean.show(5, truncate=False)

POSTGRES_URL = "jdbc:postgresql://localhost:5432/glowcart_db"
POSTGRES_PROPS = {
    "user": "glowcart",
...
print("Data berhasil dimuat ke tabel raw_orders di PostgreSQL!")
spark.stop()